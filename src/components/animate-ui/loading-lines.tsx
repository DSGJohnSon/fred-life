...
const LoadingLines: React.FC = () => {
  ...
  return (
    <div className="relative flex items-center justify-center h-[10svh] py-[10svh] max-h-[30svh] w-auto m-8 font-poppins text-[1.6em] font-semibold select-none text-white scale-[2]">
      {/* Animated letters */}
      ...
      <div className="absolute top-0 left-0 w-full h-full z-1 bg-transparent [mask:repeating-linear-gradient(90deg,transparent_0,transparent_6px,black_7px,black_8px)]">
        <div
          ...
          bg-[radial-gradient(circle_at_50%_50%,#ff0_0%,transparent_50%),radial-gradient(circle_at_45%_45%,#f00_0%,transparent_45%),radial-gradient(circle_at_55%_55%,#0ff_0%,transparent_45%),radial-gradient(circle_at_45%_55%,#0f0_0%,transparent_45%),radial-gradient(circle_at_55%_45%,#00f_0%,transparent_45%)]
